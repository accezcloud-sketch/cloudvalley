    ...
    <>
      ...
      <section className="border-b border-rule">
        <div className="mx-auto w-full max-w-[1440px] grid grid-cols-1 gap-10 px-6 py-24 md:grid-cols-12 md:gap-16 md:px-10 md:py-32">
          ...
          >
            {isAr
              ? "سؤالٌ عن الشروط؟ نحن هنا."
              : "A question about our terms? We're here."}
          </h3>
          <a
            href={waLink(
              isAr
                ? "أهلًا، لديّ سؤال حول شروط الخدمة."
                : "Hi — I have a question about your terms of service.",
            )}
            target="_blank"
            rel="noreferrer"
